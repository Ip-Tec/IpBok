...
const CTASection = () => {
  return (
    <section id="pricing" className="relative overflow-hidden bg-gradient-hero py-24">
      ...
      <div className="container relative mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-8 text-lg text-muted-foreground">
            Join thousands of individuals and businesses who have simplified their accounting. 
            Start free today — upgrade anytime for advanced business features.
          </p>
